	...
	<div class="card">
		...
		<div class="card-header">    
			<div class="card-title">
				<button type="button" onclick="window.location.href='{{ route("admin.Survey.list") }}'" class="btn btn-default btn-sm">Reset</button>
			</div>                 
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<a href="#" onclick="deleteSurvey({{ $Survey->id }})" class="text-danger w-4 h-4 mr-1">
